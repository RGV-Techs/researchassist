...
const Presentation = () => {
  ...
  const slidePreview = [
    ...
    { icon: Layers, title: "System Architecture", description: "Multi-layer system design" },
    ...
    { icon: Cpu, title: "ML Model Results", description: "5 models compared, 97.25% accuracy" },
    { icon: Cpu, title: "Per-Class Performance", description: "F1-scores per domain (macro 0.97)" },
